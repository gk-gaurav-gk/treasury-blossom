...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary-600 hover:shadow-md rounded-button",
        solid: "bg-text text-bg hover:bg-text/90 hover:shadow-md rounded-button font-medium",
        outline: "border border-border bg-transparent text-text hover:bg-surface hover:border-muted rounded-button font-medium",
        ghost: "text-muted hover:text-text hover:bg-surface rounded-button",
